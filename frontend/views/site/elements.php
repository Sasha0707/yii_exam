...
<div class="whole-wrap pb-100">
    <div class="container">
        <div class="section-top-border">
            ...
            <div class="row">
                <div class="col-md-3">
                    <img src="<?= \yii\helpers\Url::to('@web/img/elements/d.jpg')?>" alt="" class="img-fluid">
                </div>
            ...
            <div class="progress-table-wrap">
                <div class="progress-table">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<?= \yii\helpers\Url::to('@web/img/elements/f1.jpg')?>" alt="flag">Canada</div>
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<?= \yii\helpers\Url::to('@web/img/elements/f2.jpg')?>" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<?= \yii\helpers\Url::to('@web/img/elements/f3.jpg')?>" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<?= \yii\helpers\Url::to('@web/img/elements/f4.jpg')?>" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<?= \yii\helpers\Url::to('@web/img/elements/f5.jpg')?>" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<?= \yii\helpers\Url::to('@web/img/elements/f6.jpg')?>" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<?= \yii\helpers\Url::to('@web/img/elements/f7.jpg')?>" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<?= \yii\helpers\Url::to('@web/img/elements/f8.jpg')?>" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
        ...
        <div class="section-top-border">
            ...
            <div class="row gallery-item">
                <div class="col-md-4">
                    <a href="<?= \yii\helpers\Url::to('@web/img/elements/g1.jpg')?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(<?= \yii\helpers\Url::to('@web/img/elements/g1.jpg')?>);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<?= \yii\helpers\Url::to('@web/img/elements/g2.jpg')?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(<?= \yii\helpers\Url::to('@web/img/elements/g2.jpg')?>);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<?= \yii\helpers\Url::to('@web/img/elements/g3.jpg')?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(<?= \yii\helpers\Url::to('@web/img/elements/g3.jpg')?>);"></div>
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="<?= \yii\helpers\Url::to('@web/img/elements/g4.jpg')?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(<?= \yii\helpers\Url::to('@web/img/elements/g4.jpg')?>);"></div>
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="<?= \yii\helpers\Url::to('@web/img/elements/g5.jpg')?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(<?= \yii\helpers\Url::to('@web/img/elements/g5.jpg')?>);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<?= \yii\helpers\Url::to('@web/img/elements/g6.jpg')?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(<?= \yii\helpers\Url::to('@web/img/elements/g6.jpg')?>);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<?= \yii\helpers\Url::to('@web/img/elements/g7.jpg')?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(<?= \yii\helpers\Url::to('@web/img/elements/g7.jpg')?>);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<?= \yii\helpers\Url::to('@web/img/elements/g8.jpg')?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(<?= \yii\helpers\Url::to('@web/img/elements/g8.jpg')?>);"></div>
                    </a>
                </div>
            </div>
        </div>
